				...
				<div class="panel panel-orange panel-widget ">
					<div class="row no-padding">
						...
						<div class="col-sm-9 col-lg-7 widget-right">
							...
							<div class="text-muted">Produks</div>
						</div>
					</div>
				</div>
			</div>
	...
	<div class="row">
		...
		<div class="panel panel-default">
			<div class="alert bg-primary" role="alert">
				<svg class="glyph stroked empty-message"><use xlink:href="#stroked-empty-message"></use></svg> Selamat Datang di HiuSport, <b><i>{{ Auth::user()->name }}!</i></b> <a href="#" class="pull-right"></a>
			</div>
		</div>
		</div>
		<div class="col-md-4">
