                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <table class="table table-bordered table-hover table-striped">
                                ...
                                <tr>
                                    <td>Pesan</td><td>:</td>
                                    <td><textarea style="width:100%;height:100px;" readonly>{{ $data->message }}</textarea></td>
                                </tr>
                                <!-- <tr>
                            ...
                            <a href="{{ url('/list/kritik/saran/') }}"><div class="btn btn-primary">Back</div></a>

                            <a class="pull-right" href="{{ url('/list/kritik/saran/delete/'.$data->id) }}" onclick="return confirm('Yakin Hapus ?')"><div class="btn btn-default">Hapus</div></a><br><br>
                        <script>
                            $(function () {
