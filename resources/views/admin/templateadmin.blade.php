...
<body>
	<nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
		<div class="container-fluid">
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="{{ url('/') }}"><span>Hiu</span>Sport</a>
				@if(Auth::check())
				<ul class="user-menu">
	...
	<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
		...
		<ul class="nav menu">
			@if(Auth::user())
			<li {{ Request::is('home') || Request::is('/') || Request::is('admin') ? 'class=active' : '' }}><a href="{{ url('/home') }}"><svg class="glyph stroked home"><use xlink:href="#stroked-home"/></svg> Home</a></li>
			...
			<li {{ Request::is('list/pesanan')  ? 'class=active' : '' }}><a href="{{ url('/list/pesanan') }}"><svg class="glyph stroked clipboard with paper"><use xlink:href="#stroked-clipboard-with-paper"/></svg> List Pesanan</a></li>
			<li {{ Request::is('list/kritik/saran') || Request::is('/') ? 'class=active' : '' }}><a href="{{ url('/list/kritik/saran') }}"><svg class="glyph stroked app window with content"><use xlink:href="#stroked-app-window-with-content"/></svg> List Kritik/Saran</a></li>
			...
			<li {{ Request::is('contact/admin') ? 'class=active' : '' }}>
				<a class="" href="{{ url('/contact/admin') }}">
