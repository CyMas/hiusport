...
<body id="page-top" class="index">
    ...
    <nav id="mainNav" class="navbar navbar-default navbar-custom navbar-fixed-top">
        <div class="container">
            ...
            <div class="navbar-header page-scroll">
                ...
                <a class="navbar-brand page-scroll" href="#page-top">HiuSport</a>
            </div>
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li>
                        <a class="page-scroll" href="#team">Owner</a>
                    </li>
    ...
    <header>
        <div class="container">
            <div class="intro-text">
                <div class="intro-lead-in">Welcome to HiuSport!</div>
                <div class="intro-heading">Hius Modification</div>
                <a href="#contact" class="page-scroll btn btn-xl">Tell Me More</a>
            </div>
        </div>
    </header>
            ...
            @foreach($produk as $key => $value)
                <div class="col-md-4 col-sm-6 portfolio-item">
                    <a href="#{{ $value->id }}" class="portfolio-link" data-toggle="modal">
                        ...
                        <img style="height:250px;" src="/{{ $value->foto }}" class="img-responsive" alt="">
                    <!-- <img style="height:250px;" src="/{{ $value->foto }}" class="img-responsive" alt="">
                     --></a>
    ...
    <section id="pesanproduk">
        <div class="container">
            <div class="row">
                <div class="col-lg-12 text-center">
                    <h2 class="section-heading">Pesan Produk</h2>
                    ...
                    <input type="hidden" name="_token" value="{{ csrf_token() }}">
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    <input type="email" class="form-control" placeholder="Email" id="email_pemesan" name="email_pemesan" data-validation-required-message="Please enter your email address.">
                                    <p class="help-block text-danger"></p>
                                </div>
                                <div class="form-group">
                                    <input type="number" class="form-control" placeholder="No Tlp/Hp*" id="phone_pemesan" name="phone_pemesan" required data-validation-required-message="Please enter your phone number.">
                                    <p class="help-block text-danger"></p>
                                </div>
                                <div class="form-group">
                                    <textarea class="form-control" placeholder="Keterangan" id="keterangan_pemesan" name="keterangan_pemesan" data-validation-required-message="Please enter a message."></textarea>
                                    <p class="help-block text-danger"></p>
                                </div>
                            </div>
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    <input id="stok" class="form-control" type="hidden" autocomplete="off" required readonly>
                                    <p class="help-block text-danger"></p>
                                </div>
                                <div class="form-group">
                                    <input id="totalStok" class="form-control" name="stok" id="stok" type="hidden" autocomplete="off" required readonly>
                                    <p class="help-block text-danger"></p>
                                </div>
                                <div class="form-group">
                    ...
                    <input type="hidden" name="_token" value="{{ csrf_token() }}">
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    <input type="number" class="form-control" placeholder="Your Phone *" id="phone" name="phone" required data-validation-required-message="Please enter your phone number.">
                                    <p class="help-block text-danger"></p>
                                </div>
                            </div>
                            <div class="col-md-6">
    ...
    <section id="team" class="bg-light-gray">
        <div class="container">
            <div class="row">
                <div class="col-lg-12 text-center">
                    <h2 class="section-heading">HiuSport</h2>
                    <h3 class="section-subheading text-muted">Owner</h3>
                </div>
            </div>
            <div class="row">
                <div class="col-sm-4">
                ...
                <div class="col-sm-4">
                    <div class="team-member">
                        ...
                        <h4>Hius Wahyudi</h4>
                        <p class="text-muted">+6287881536712</p>
                        <ul class="list-inline social-buttons">
                            <li><!-- <a href="#"><i class="fa fa-twitter"></i></a> -->
                            </li>
                            <li><a href="https://www.facebook.com/100006308827793" target="_blank"><i class="fa fa-facebook"></i></a>
                            </li>
                            <li><!-- <a href="#"><i class="fa fa-linkedin"></i></a> -->
                            </li>
                        </ul>
    ...
    <footer>
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-4">
                <span class="copyright">Copyright &copy; HiuSport 2017</span>
                    <!-- <ul class="list-inline social-buttons">
                        <li><a href="#"><i class="fa fa-twitter"></i></a>
                        </li>
                        <li><a href="#"><i class="fa fa-facebook"></i></a>
    ...
    $("#jumlahPesanan").keyup(function(){
        $("#totalStok").val($("#stok").val() - $("#jumlahPesanan").val());
    });
